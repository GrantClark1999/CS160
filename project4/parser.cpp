...
{
  "$end", "error", "$undefined", "T_EXTENDS", "T_OPENCURLY",
  "T_CLOSEDCURLY", "T_COMMA", "T_ARROW", "T_RETURN", "T_NEW", "T_DOT",
  "T_IF", "T_ELSE", "T_DO", "T_WHILE", "T_PRINT", "T_ASSIGN",
  "T_SEMICOLON", "T_TRUE", "T_FALSE", "T_OR", "T_AND", "T_NOT", "T_GTR",
  "T_GEQ", "T_EQUALS", "T_BOOLEAN", "T_INTEGER", "T_NONE", "T_PLUS",
  "T_MINUS", "T_MULT", "T_DIV", "T_OPENPAREN", "T_CLOSEDPAREN", "T_ID",
  "T_NUMBER", "$accept", "Start", "Classes", "Class", "ClassBody",
  "Methods", "Method", "Parameters", "Parameter", "MethodBody",
  "Declarations", "Declaration", "Type", "Ids", "Statements", "Statement",
  "Return", "Assignment", "MethodCall", "IfElse", "While", "DoWhile",
  "Block", "Print", "Arguments", "Arguments_", "Expression", YY_NULLPTR
};
#endif
...
{
     -16,    63,    28,   -16,   -95,    -5,    90,   -95,   -95,    32,
     -95,   -95,   -95,    -1,    76,    45,   -95,    90,   -95,    61,
      90,   -95,   -95,    -1,   -95,    45,   -95,   -95,    59,    99,
     223,    72,   -95,   -95,   107,   -95,   -95,    80,   -95,   226,
     113,   127,   -95,    64,    75,    75,   133,    75,    75,    96,
     136,    64,    87,   -95,   -95,   -95,   121,   -95,   -95,   -95,
     -95,   110,   -95,   -95,    75,    75,    75,     5,   -95,   -95,
     103,    39,    74,   132,    39,   119,   112,    75,    75,   -95,
      87,   -95,    96,   -95,   -95,   -95,   120,   -95,   -95,   164,
     122,   -95,    75,    75,    75,    75,    75,    75,    75,    75,
      75,   142,    12,   128,   -95,   -95,    13,   135,     3,   -95,
     194,   -95,    75,   -95,   129,   206,   216,   233,   233,   233,
      42,    42,   -95,   -95,   133,   -95,    75,    75,    75,   -95,
      75,   -95,     8,   -95,   179,   151,    10,   194,   -95,   146,
     -95,   -95,   -95
};
...
static const yytype_int8 yydefact[] =
{
      ...
      29,    30,    31,    32,     0,     9,    12,     8,    27,     0,
      10,    15,     5,     0,    11,     7,    26,    34,     0,     0,
       0,     0,    28,     6,     0,    32,    14,     0,    33,     0,
      16,     0,    17,    25,     0,     0,     0,     0,     0,    32,
       0,    21,    23,    36,    24,    37,     0,    39,    40,    41,
      42,     0,    74,    75,     0,     0,     0,    69,    73,    71,
       0,     0,     0,     0,     0,     0,     0,     0,    55,    13,
      19,    20,     0,    35,    22,    38,    76,    67,    68,     0,
       0,    43,     0,     0,     0,     0,     0,     0,     0,     0,
       0,    48,     0,     0,    50,    53,     0,     0,     0,    54,
      57,    18,    55,    72,    70,    66,    65,    62,    63,    64,
      58,    59,    60,    61,     0,    52,     0,     0,    55,    44,
       0,    46,     0,    49,     0,     0,     0,    56,    77,     0,
      45,    47,    51
};
...
{
     -95,   -95,   -95,   166,   150,   156,    88,   -95,   -95,   -95,
     134,   -11,    91,   -95,   -27,   -45,   -39,   -95,   -41,   -95,
     -95,   -95,   -66,   -95,   -94,   -95,   -44
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     4
      -1,    -1,    -1,    29,    30,    31,    32,    21,    -1,    23,
      24,    25,    -1,    -1,    -1,    29,    30,    31,    32,    23,
      24,    25,    -1,    -1,    -1,    29,    30,    31,    32,    26,
      27,    28,    26,    27,    28,    -1,    -1,    34,    35,    -1,
      -1,    35,    29,    30,    31,    32
};
...
{
       0,    35,    38,    39,    40,     3,     4,     0,    40,    35,
      26,    27,    28,    35,    41,    42,    43,    47,    48,    49,
       4,    33,     5,    35,    43,    42,    48,    35,    50,    41,
      44,     6,    17,     5,    34,    35,    45,    49,    35,     7,
      35,    49,     6,     4,     8,    11,    13,    14,    15,    35,
      46,    47,    51,    52,    53,    54,    55,    56,    57,    58,
      60,     9,    18,    19,    22,    30,    33,    35,    36,    55,
      63,    63,     4,    59,    63,    63,    10,    16,    33,     5,
      51,    53,    35,    52,    53,    17,    35,    63,    63,    63,
      10,    17,    20,    21,    23,    24,    25,    29,    30,    31,
      32,    59,    51,    14,    59,    17,    35,    63,    61,    62,
      63,    53,    33,    34,    35,    63,    63,    63,    63,    63,
      63,    63,    63,    63,    12,     5,    33,    16,    33,    17,
       6,    34,    61,    59,    63,    63,    61,    63,    34,    34,
      17,    34,    17
};
...
#line 1527 "parser.cpp"
  ...
  case 14:
#line 91 "parser.y"
                                      { (yyval.parameter_list_ptr) = (yyvsp[-1].parameter_list_ptr); (yyval.parameter_list_ptr)->push_back((yyvsp[0].parameter_ptr)); }
...
#line 1545 "parser.cpp"
  ...
  case 17:
#line 96 "parser.y"
                                  { (yyval.parameter_ptr) = new ParameterNode((yyvsp[-2].type_ptr), new IdentifierNode((yyvsp[-1].base_char_ptr))); }
...
#line 1569 "parser.cpp"
  ...
  case 21:
#line 102 "parser.y"
                                                { (yyval.methodbody_ptr) = new MethodBodyNode((yyvsp[0].declaration_list_ptr), new std::list<StatementNode*>(), NULL); }
...
#line 1581 "parser.cpp"
  ...
  case 23:
#line 104 "parser.y"
                                                { (yyval.methodbody_ptr) = new MethodBodyNode(new std::list<DeclarationNode*>(), (yyvsp[0].statement_list_ptr), NULL); }
...
#line 1593 "parser.cpp"
  ...
  case 25:
#line 106 "parser.y"
                                                { (yyval.methodbody_ptr) = new MethodBodyNode(new std::list<DeclarationNode*>(), new std::list<StatementNode*>(), NULL); }
...
#line 1731 "parser.cpp"
  ...
  case 48:
#line 149 "parser.y"
                                                    { (yyval.ifelse_ptr) = new IfElseNode((yyvsp[-1].expression_ptr), (yyvsp[0].statement_list_ptr), NULL); }
#line 1737 "parser.cpp"
    break;

  case 49:
#line 150 "parser.y"
                                                    { (yyval.ifelse_ptr) = new IfElseNode((yyvsp[-3].expression_ptr), (yyvsp[-2].statement_list_ptr), (yyvsp[0].statement_list_ptr)); }
#line 1743 "parser.cpp"
    break;

  case 50:
#line 153 "parser.y"
                                          { (yyval.while_ptr) = new WhileNode((yyvsp[-1].expression_ptr), (yyvsp[0].statement_list_ptr)); }
#line 1749 "parser.cpp"
    break;

  case 51:
#line 156 "parser.y"
                                                                                    { (yyval.dowhile_ptr) = new DoWhileNode((yyvsp[-5].statement_list_ptr), (yyvsp[-2].expression_ptr)); }
